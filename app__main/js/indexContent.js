...
<html lang="es">
  <head>
    ...
    <link rel="preload" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/css/styles.css" as="style" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/css/styles.css" media="all" />
    <link
  ...
  <body class="bg-gray-900 text-white">
    ...
    <script type="module" src="cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latesthttps://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/./js/script.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/./js/home.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/./js/series.js" defer></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/./js/adultContent.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/./js/configuracion.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/./js/aboutAndDMCA.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/./js/buscador.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/./js/config.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@latest/app__main/./js/favoritos.js"></script>
