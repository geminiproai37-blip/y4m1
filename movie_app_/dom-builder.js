...
export function buildHeader() {
  ...
  header.querySelector("#search-btn").addEventListener("click", () => {
    window.location.href = "https://yamilatintern.blogspot.com/p/yami-lat-tu-guia-de-anime-crear-un.html#buscador";
  });
  header.querySelector("#back-btn").addEventListener("click", () => {
    window.location.href = "https://yamilatintern.blogspot.com/p/yami-lat-tu-guia-de-anime-crear-un.html#home";
  });
