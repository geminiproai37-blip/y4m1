...
export async function buildMovieDetailPage(
  ...
  trailerButton.className =
    "bg-orange-600 text-white px-6 py-3 rounded-lg font-bold flex items-center justify-center transition-colors hover:bg-orange-700 text-base trailer-btn"; // Added trailer-btn class
  trailerButton.innerHTML = '<i class="fas fa-play mr-2"></i> Ver Trailer';
